...
public class SNOWOAuthClient implements IOAuthClient {
    ...
    public SNOWOAuthClient (String oauthurl, String client_id, String client_secret, String userName, String password, Configuration configuration) {
        this.oauthurl = oauthurl;
        this.authParameters.add( new BasicNameValuePair("grant_type","password"));
        ...
        this.authParameters.add( new BasicNameValuePair("username", userName));
        this.authParameters.add( new BasicNameValuePair("password", password));
    }
